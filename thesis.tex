...
\committee{
    \chair{Michael Longford}{Graduate Program Director, Digital Media Program}
    \member{Graham Wakefield}{Supervisor \\ Associate Professor, Digital Media Program}
    \member{Joel Ong}{Committee Member \\ Associate Professor, Digital Media Program}
    \member{Andreas Kitzmann}{Committee Member \\ Associate Professor, Department Of Humanities}
    \member{Vassilios (Bil) Tzerpos}{Examiner \\ Associate Professor, Department of Electrical Engineering \& Computer Science, Lassonde School of Engineering}
    \member{Sang Won Lee}{External Examiner \\ Associate Professor, Department of Computer Science, College of Engineering, Virginia Polytechnic Institute and State University}
}
...
\include{appendix/appendix-synthAppExcerpts.tex}
